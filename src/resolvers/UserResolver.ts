...
export class UserResolver {
  ...
  async register(
    @Ctx() { em }: EmContext,
    @Arg("registerData", () => UserRegisterResolverObject)
    registerData: UserRegisterObject
  ): Promise<UserRegisterResponse> {
    const userAlready = await em.findOne(User, {
  ...
  async login(
    @Ctx() { em }: EmContext,
    @Arg("loginData", () => UserRegisterResolverObject)
    registerData: UserRegisterObject
